ig.module('game.entities.changer').requires('impact.entity', 'game.entities.base').defines(function() {
  EntityChanger = ig.Entity.extend({
    ...
    check: function(other) {
      if (other instanceof EntityPrincess || other instanceof EntityDragon) {
